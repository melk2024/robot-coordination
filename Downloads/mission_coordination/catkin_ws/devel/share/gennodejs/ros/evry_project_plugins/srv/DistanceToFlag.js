...
class DistanceToFlagResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('flag_x')) {
        this.flag_x = initObj.flag_x
      }
      else {
        this.flag_x = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [flag_x]
    bufferOffset = _serializer.float64(obj.flag_x, buffer, bufferOffset);
    // Serialize message field [flag_y]
    bufferOffset = _serializer.float64(obj.flag_y, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [flag_x]
    data.flag_x = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [flag_y]
    data.flag_y = _deserializer.float64(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.flag_x !== undefined) {
      resolved.flag_x = msg.flag_x;
    }
    else {
      resolved.flag_x = 0.0
    }
...
module.exports = {
  ...
  md5sum() { return '78c76cbdc6b60816a621f2ca0d7237a4'; },
