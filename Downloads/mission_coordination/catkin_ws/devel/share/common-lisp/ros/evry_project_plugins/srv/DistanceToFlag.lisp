...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DistanceToFlag-request>)))
  ...
  "78c76cbdc6b60816a621f2ca0d7237a4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DistanceToFlag-request)))
  "Returns md5sum for a message object of type 'DistanceToFlag-request"
  "78c76cbdc6b60816a621f2ca0d7237a4")
...
(cl:ensure-generic-function 'flag_x-val :lambda-list '(m))
(cl:defmethod flag_x-val ((m <DistanceToFlag-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader evry_project_plugins-srv:flag_x-val is deprecated.  Use evry_project_plugins-srv:flag_x instead.")
  (flag_x m))

(cl:ensure-generic-function 'flag_y-val :lambda-list '(m))
(cl:defmethod flag_y-val ((m <DistanceToFlag-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader evry_project_plugins-srv:flag_y-val is deprecated.  Use evry_project_plugins-srv:flag_y instead.")
  (flag_y m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <DistanceToFlag-response>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'flag_x))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'flag_y))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DistanceToFlag-response>) istream)
  "Deserializes a message object of type '<DistanceToFlag-response>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'flag_x) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'flag_y) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DistanceToFlag-response>)))
  ...
  (cl:format cl:nil "float64 distance~%float64 flag_x~%float64 flag_y~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DistanceToFlag-response)))
  "Returns full string definition for message of type 'DistanceToFlag-response"
  (cl:format cl:nil "float64 distance~%float64 flag_x~%float64 flag_y~%~%~%~%"))
